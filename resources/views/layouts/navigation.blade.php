            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <form method="GET" action="{{ route('products.search') }}" class="relative flex items-center transition-transform duration-300 hover:scale-110">
                            <input type="text" name="query" placeholder="Search..." class="border rounded-md p-2 mt-3 transition-all duration-300 focus:ring-2 focus:ring-indigo-500" />
